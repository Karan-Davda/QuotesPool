<%@ Page Title="" Language="C#" MasterPageFile="~/Content/QuotesPoolMaster.master" AutoEventWireup="true" CodeFile="QuotesByCategory.aspx.cs" Inherits="Frontend_QuotesByCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
            ...
            <ul>
                <li class="slide-overlay slide-overlay-level-8" data-transition="fade">
                    ...
                    <h1 class="tp-caption font-weight-extra-bold text-color-light negative-ls-2"
                        data-frames='[{"delay":100,"speed":2000,"frame":"0","from":"sX:1.5;opacity:0;fb:0px;","to":"o:1;fb:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;fb:0;","ease":"Power3.easeInOut"}]'
                        data-x="center"
                        data-y="center"
                        data-fontsize="['40','55','90','95']"
                        data-lineheight="['55','55','90','95']"
                        style="top: -25px">
                        <asp:Label ID="lblCategory1" runat="server"></asp:Label></h1>

                    <a class="tp-caption btn btn-rounded-icon text-color-light"
                        style="display: inline-flex !important"
                        data-frames='[{"delay":1000,"speed":1500,"frame":"0","from":"sX:1.5;opacity:0;fb:0px;","to":"o:1;fb:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;fb:0;","ease":"Power3.easeInOut"}]'
                        href="#main"
                        data-has=""
    ...
    <div class="container-fluid pl-5 pr-5 mt-0 pt-0" id="main">
        ...
        <div class="row">
            <div class="col-md-9 sort-destination-loader pt-2 sort-destination-loader-loaded">
                <div class="card-columns">
                    <asp:Repeater ID="rpQuoteByCategory" runat="server">
                        <ItemTemplate>
                            <div class="card quoteCard pl-3 pr-3 pt-3 mb-3 pb-0 text-left appear-animation animated fadeInRight appear-animation-visible" data-appear-animation="fadeInRight" data-appear-animation-delay="0" data-appear-animation-duration="3s" style="animation-duration: 3s; animation-delay: 0ms;">
                                        ...
                                        <div class="post-meta pl-2">
                                            <div>
                                                <span><i class="far fa-user"></i>
                                                    <asp:HyperLink ID="hlAuthor" runat="server"  NavigateUrl='<%# "~/"+Eval("AuthorURL").ToString()+"/quotes" %>' Text='<%# " "+Eval("AuthorName").ToString() %>' ToolTip='<%# Eval("AuthorName").ToString()+" quotes" %>'></asp:HyperLink></span>
                                            </div>
                                            <div>
                                                <span><i class="far fa-calendar"></i>
                                                    <asp:Label runat="server" CssClass="pl-1 text-primary"><%# Eval("Created").ToString() %></asp:Label></span>
                                                <br />
                                            </div>
